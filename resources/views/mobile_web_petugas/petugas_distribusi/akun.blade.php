...
<div class="p-4 space-y-4" x-data="akunPetugasDistribusi()">
    ...
    <div x-show="settingsModal" 
        ...
        <div class="bg-white rounded-3xl w-full max-w-sm overflow-hidden shadow-2xl p-5 space-y-4 text-left">
            <div class="flex items-center justify-between border-b border-slate-100 pb-2">
                <div class="flex items-center gap-2">
            ...
            <div class="space-y-3.5 text-xs">
                ...
                <div class="p-3.5 bg-slate-50 border border-slate-100 rounded-2xl flex items-center justify-between">
                    <div>
                        ...
                        <span class="text-[10px] text-slate-400 font-medium">Alert pengiriman & pesanan</span>
                    </div>
                    <input type="checkbox" checked class="w-4 h-4 accent-navy-800 rounded cursor-pointer">
                </div>

                <!-- Alert Pengiriman WhatsApp -->
                <div class="p-3.5 bg-slate-50 border border-slate-100 rounded-2xl flex items-center justify-between">
                    <div>
                        <span class="font-extrabold text-navy-900 block">Alert WhatsApp</span>
                        <span class="text-[10px] text-slate-400 font-medium">Update status pengiriman</span>
                    </div>
                    <input type="checkbox" checked class="w-4 h-4 accent-navy-800 rounded cursor-pointer">
                </div>
            </div>
