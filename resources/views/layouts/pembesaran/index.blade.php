                        ...
                        <div class="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between">
                            ...
                            <div class="flex items-center gap-1.5">
                                <button type="button" @click="openEdit(item)" 
                                        class="px-2.5 py-1 rounded-lg bg-amber-50 text-amber-700 hover:bg-amber-100 font-bold text-xs flex items-center gap-1 transition-colors">
                                    <i class="fa-solid fa-pen-to-square text-[10px]"></i>
                                    <span>Edit</span>
                                </button>
                                <button type="button" @click="deleteBatch(item)" 
                                        class="px-2.5 py-1 rounded-lg bg-rose-50 text-rose-700 hover:bg-rose-100 font-bold text-xs flex items-center gap-1 transition-colors">
