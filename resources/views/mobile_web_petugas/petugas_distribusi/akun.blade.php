    ...
    <div x-show="editProfileModal" 
        ...
        <div class="bg-white rounded-3xl w-full max-w-sm overflow-hidden shadow-2xl p-5 space-y-4">
            ...
            <div class="space-y-3">
                ...
                <div>
                    <label class="text-[10px] font-extrabold uppercase text-slate-500 block mb-1" x-text="i18n[currentLang].phone">NOMOR HANDPHONE / WHATSAPP</label>
                    <div class="flex items-center rounded-xl border border-slate-200 overflow-hidden focus-within:border-navy-800 bg-white">
