        ...
        <div class="bg-white rounded-3xl w-full max-w-sm overflow-hidden shadow-2xl p-5 space-y-4">
            ...
            <div class="space-y-3">
                ...
                <div>
                    ...
                    <div class="flex items-center rounded-xl border border-slate-200 overflow-hidden focus-within:border-sky-600 bg-white">
        ...
        <div class="bg-white rounded-3xl w-full max-w-xs overflow-hidden shadow-2xl p-5 space-y-4">
            ...
            <div class="space-y-2 text-xs">
                <button @click="setLanguage('id')" 
                        ...
                        :class="currentLang === 'id' ? 'border-sky-600 bg-sky-50 text-sky-800 font-extrabold' : 'border-slate-100 hover:bg-slate-50 text-slate-700'">
                    <span class="flex items-center gap-2">🇮🇩 Bahasa Indonesia</span>
                    <div x-show="currentLang === 'id'" class="w-5 h-5 rounded-full bg-sky-600 text-white flex items-center justify-center text-[10px]">
                        <i class="fa-solid fa-check text-[11px]"></i>
                    </div>
                </button>
                <button @click="setLanguage('en')" 
                        class="w-full p-3 rounded-2xl border text-left flex items-center justify-between transition-all"
                        :class="currentLang === 'en' ? 'border-sky-600 bg-sky-50 text-sky-800 font-extrabold' : 'border-slate-100 hover:bg-slate-50 text-slate-700'">
                    <span class="flex items-center gap-2">🇬🇧 English</span>
                    <div x-show="currentLang === 'en'" class="w-5 h-5 rounded-full bg-sky-600 text-white flex items-center justify-center text-[10px]">
                        <i class="fa-solid fa-check text-[11px]"></i>
                    </div>
                </button>
            </div>
