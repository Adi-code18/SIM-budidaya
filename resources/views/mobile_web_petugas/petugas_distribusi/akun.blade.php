...
<div class="p-4 space-y-4" x-data="akunPetugasDistribusi()">
        ...
        <div class="bg-white rounded-3xl w-full max-w-sm overflow-hidden shadow-2xl p-5 space-y-4">
            ...
            <div class="space-y-3">
                <div>
                    ...
                    <input type="text" x-model="tempName" class="w-full px-3.5 py-2 rounded-xl border border-slate-200 text-xs font-semibold text-slate-800 focus:outline-none focus:border-navy-800">
                </div>
                <div>
    ...
    <div x-show="settingsModal" 
        ...
        <div class="bg-white rounded-3xl w-full max-w-sm overflow-hidden shadow-2xl p-5 space-y-4 text-left max-h-[90vh] overflow-y-auto">
    ...
    return {
        ...
        async saveProfile() {
            ...
            try {
                ...
                const res = await fetch('{{ route('mobile.petugas.profile.update') }}', {
                    method: 'POST',
                    headers: {
