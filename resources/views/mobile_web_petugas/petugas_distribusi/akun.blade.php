...
<div class="p-4 space-y-4" x-data="{ 
    ...
    userRole: 'Petugas Logistik & Distribusi',
    ...
    <div class="bg-white rounded-3xl border border-slate-200/90 p-5 shadow-xs flex flex-col items-center text-center relative overflow-hidden">
        ...
        <div class="mt-3 relative z-10 space-y-1">
            ...
            <p class="text-xs text-slate-500 font-semibold" x-text="userRole">Petugas Logistik</p>
        </div>
    </div>
        ...
        <button @click="triggerToast('Pengaturan notifikasi berhasil disimpan', 'info')"
            ...
            <div class="flex items-center gap-3.5">
                ...
                <div>
                    ...
                    <p class="text-[10px] text-slate-400 font-medium">Suara, alert pengiriman & push notify</p>
                </div>
            </div>
           ...
           class="w-full p-4 flex items-center justify-between hover:bg-slate-50 transition-colors text-left">
            <div class="flex items-center gap-3.5">
                ...
                <div>
                    ...
                    <p class="text-[10px] text-slate-400 font-medium">FAQ, Panduan app & CS Support</p>
                </div>
            </div>
            <i class="fa-solid fa-chevron-right text-slate-400 text-xs"></i>
        </a>
    ...
    <div x-show="editProfileModal" 
        ...
        <div class="bg-white rounded-3xl w-full max-w-sm overflow-hidden shadow-2xl p-5 space-y-4">
            <div class="flex items-center justify-between border-b border-slate-100 pb-2">
                <h3 class="text-xs font-bold text-navy-900">Edit Profile Petugas</h3>
            ...
            <div class="space-y-3">
                ...
                <div>
                    <label class="text-[10px] font-extrabold uppercase text-slate-500 block mb-1">NOMOR HANDPHONE</label>
    ...
    <div x-show="logoutModal" 
        ...
        <div class="bg-white rounded-3xl w-full max-w-sm overflow-hidden shadow-2xl p-5 space-y-4 text-center">
            ...
            <div>
                ...
                <p class="text-xs text-slate-500 font-medium mt-1">Apakah Anda yakin ingin keluar dari akun SIM-BUDIDAYA Mobile?</p>
            </div>
            ...
            <div class="grid grid-cols-2 gap-2 pt-2">
                ...
                <a href="{{ route('mobile.petugas.login') }}" class="py-2.5 rounded-xl bg-rose-600 text-white font-bold text-xs flex items-center justify-center">
                    Ya, Keluar
                </a>
            </div>
        </div>
