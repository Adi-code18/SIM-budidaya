            ...
            <div class="space-y-3.5 text-xs">
                ...
                <div class="p-3.5 bg-slate-50 border border-slate-100 rounded-2xl flex items-center justify-between">
                    <div>
                        ...
                        <span class="text-[10px] text-slate-400 font-medium">Alert biomassa, pH air & pakan</span>
                    </div>
                    <input type="checkbox" checked class="w-4 h-4 accent-emerald-700 rounded cursor-pointer">
                </div>
                ...
                <div class="p-3.5 bg-slate-50 border border-slate-100 rounded-2xl flex items-center justify-between">
                    <div>
                        ...
                        <span class="text-[10px] text-slate-400 font-medium">Laporan kematian ikan</span>
                    </div>
                    <input type="checkbox" checked class="w-4 h-4 accent-emerald-700 rounded cursor-pointer">
                </div>
            </div>
