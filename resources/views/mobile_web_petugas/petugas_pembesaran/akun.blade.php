...
<div class="p-4 space-y-4" x-data="akunPetugasPembesaran()">
    ...
    <div class="bg-white rounded-3xl border border-slate-200/90 p-5 shadow-xs flex flex-col items-center text-center relative overflow-hidden">
        ...
        <div class="w-full h-16 bg-gradient-to-r from-navy-800 to-emerald-700 absolute top-0 left-0"></div>
        ...
        <div class="relative z-10 mt-4">
            ...
            <template x-if="!userPhoto">
                <div class="w-20 h-20 rounded-full border-4 border-white shadow-md mx-auto bg-gradient-to-tr from-emerald-600 to-navy-900 flex items-center justify-center text-white text-2xl font-black" 
    ...
    <!-- Navigation Menu Options Card List -->
    ...
    <div x-show="editProfileModal" 
        ...
        <div class="bg-white rounded-3xl w-full max-w-sm overflow-hidden shadow-2xl p-5 space-y-4">
            ...
            <div class="flex flex-col items-center gap-2 pt-1 pb-2">
                <div class="relative">
                    <img :src="photoPreview" alt="Preview Foto" class="w-16 h-16 rounded-full object-cover border-2 border-emerald-100 shadow-sm bg-slate-50">
                ...
                <button type="button" @click="$refs.photoInput.click()" class="text-[11px] font-bold text-emerald-700 hover:underline cursor-pointer flex items-center gap-1">
            ...
            <div class="space-y-3">
                <div>
                    ...
                    <input type="text" x-model="tempName" class="w-full px-3.5 py-2 rounded-xl border border-slate-200 text-xs font-semibold text-slate-800 focus:outline-none focus:border-emerald-600">
                </div>
                <div>
    ...
    return {
        ...
        async saveProfile() {
            ...
            try {
                ...
                const res = await fetch('{{ route('petugas.pembesaran.profile.update') }}', {
                    method: 'POST',
                    headers: {
