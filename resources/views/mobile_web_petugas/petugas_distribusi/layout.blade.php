...
<head>
    ...
    <style>
        ...
        /* Phone Mockup Frame wrapper on larger screens */
...
<body x-data="{ 
    ...
    <div class="mobile-screen-wrapper flex flex-col justify-between">
        ...
        @hasSection('hide_nav')
        @else
        <nav class="fixed sm:absolute bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-slate-200/80 px-4 py-2 flex items-center justify-around shadow-lg">
