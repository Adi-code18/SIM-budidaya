...
<div class="space-y-6 max-w-5xl mx-auto">
    ...
    <div class="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/80 shadow-xs space-y-6">
        ...
        <!-- Form Elements -->
        <form action="#" method="POST" @submit.prevent="handleSave()" x-data="{
            kolam: '',
            waktuTanggal: '08/01/2026, 12:06 PM',
            peletKg: 0.00,
            daunKg: 0.0,
            jenisDaun: '',
            biaya: 'Rp. 120.000',
            ...
            handleSave() {
                if (!this.kolam) {
                    alert('Mohon pilih kolam pembesaran!');
                    return;
                }
                alert('Log pakan harian untuk ' + this.kolam + ' berhasil disimpan!');
                // TODO: replace with real save (AJAX or form submit to backend)
            },
            handleCancel() {
                this.kolam = '';
                this.waktuTanggal = '08/01/2026, 12:06 PM';
                this.peletKg = 0.00;
                this.daunKg = 0.0;
                this.jenisDaun = '';
                this.biaya = 'Rp. 120.000';
                this.phAir = 7.0;
            }
        }" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        <i class="fa-regular fa-calendar absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 text-xs"></i>
                           <input type="text" x-model="waktuTanggal"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-4">
                    ...
                    <div class="bg-slate-50/80 p-4 rounded-xl border border-slate-100 space-y-2">
                        ...
                        <div class="flex items-center gap-2">
                            <input type="number" x-model="peletKg"
                                step="0.01" 
                    ...
                    <div class="bg-slate-50/80 p-4 rounded-xl border border-slate-100 space-y-2">
                        ...
                        <div class="grid grid-cols-5 gap-2">
                            <input type="number" x-model="daunKg"
                                   step="0.1" 
                            ...
                            <select x-model="jenisDaun" class="col-span-3 px-3 py-2 rounded-lg border border-slate-200 text-xs font-semibold text-slate-600 bg-white focus:outline-none focus:ring-2 focus:ring-sky-500">
            ...
            <div class="flex items-center justify-end gap-3 pt-4 border-t border-slate-100">
                <button type="button" @click.prevent="handleCancel()" class="px-5 py-2 rounded-xl border border-slate-200 text-xs font-bold text-slate-600 hover:bg-slate-50 transition-colors">
                    Batal
                </button>
